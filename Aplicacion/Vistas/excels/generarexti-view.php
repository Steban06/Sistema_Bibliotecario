...
header("Content-Disposition: attachment; filename=Reporte-de-Trabajos-de-Investigación.xls");
...
<h1>Listado de Trabajos de Investigación</h1>
...
$consulta = "SELECT * FROM trabajos_investigacion";
