...
function Header()
{
    ...
    $this->Cell(35);
    // Título
    $this->Cell(30,10,'Estudiantes Registrados',0,'C');
    $this->SetFont('Arial','B',9);
    $this->Cell(108, 0, '', 'T', 0, 'C');
    $this->Ln(1.5);
    ...
    $this->Cell(26,10,utf8_decode('Dirección'), 1,0,'C',1);
    $this->Cell(40,10,utf8_decode('Email'), 1,0,'C',1);
    $this->SetFont('Arial','B',7);
    $this->Cell(12,10,utf8_decode('Carrera'), 1,0,'C',1);
    $this->Cell(12,10,utf8_decode('Semestre'), 1,0,'C',1);
    $this->Cell(12,10,utf8_decode('Estado'), 1,1,'C',1);
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->Cell(26,10,utf8_decode($row['direccion']), 1,0,'C',0);
    $pdf->Cell(40,10,utf8_decode($row['email']), 1,0,'C',0);
    $pdf->Cell(12,10,utf8_decode($row['carrera']), 1,0,'C',0);
    $pdf->Cell(12,10,utf8_decode($row['semestre']), 1,0,'C',0);
    $pdf->Cell(12,10,utf8_decode($row['estado']), 1,1,'C',0);
